 ...
 *
 * @param params - An object that may contain the following properties:
 *   - listingId: The ID of the listing for which reservations are to be retrieved.
 *   - userId: The ID of the user whose reservations are to be retrieved.
 *   - authorId: The ID of the author whose listings' reservations are to be retrieved.
 *
